...
f3::
    ...
    {
    ControlSetText, Edit1, inbound, clumsy 0.3
    ...
    Sleep, 10
    ControlFocus, Button7, clumsy 0.3
    Sleep, 10
    ControlClick, Button7, clumsy 0.3
    Sleep, 10
    ControlSetText, Edit3, 100, clumsy 0.3
    Sleep, 10
    ControlFocus, Button10, clumsy 0.3
    Sleep, 10
    ControlClick, Button10, clumsy 0.3
    Sleep, 10
    ControlSetText, Edit5, 20, clumsy 0.3
    Sleep, 10
    ControlSetText, Edit4, 1000, clumsy 0.3
    Sleep, 10
    ControlFocus, Button2, clumsy 0.3
    WinMinimize, clumsy 0.3
    }
return
x::
